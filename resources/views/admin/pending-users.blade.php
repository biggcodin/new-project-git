...
<head>
    ...
    <title>کاربران در انتظار تایید</title>
    ...
    <div class="container">
                ...
                @foreach ($users as $user)
                    <div class="user-card">
                        ...
                        <div class="action-buttons">
                            <form method="POST" action="{{ route('admin.pending.users.approve', $user) }}">
                                @csrf
                                <button type="submit" class="btn-action btn-success"
                                    onclick="return confirm('آیا مطمئنید می‌خواهید این کاربر را تایید کنید؟')">
                            ...
                            <form method="POST" action="{{ route('admin.pending.users.reject', $user) }}">
                                ...
                                <button type="submit" class="btn-action btn-danger"
                                    onclick="return confirm('آیا مطمئنید می‌خواهید این کاربر را رد کنید؟')">
        ...
        @else
            <div class="alert alert-info">
                ...
                <p style="margin: 0;">کاربری در انتظار تایید وجود ندارد.</p>
            </div>
        @endif
    </div>
</body>
